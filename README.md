...
<body data-page="index">
  ...
  <div class="cat-strip" id="catStrip">
    <div class="cat-item" onclick="navigate('index.html')">
      <div class="cat-ico">🏠</div><div class="cat-label">Home</div>
    </div>
    
    <div class="cat-item" onclick="navigate('clothes.html')">
      <div class="cat-ico">👕</div><div class="cat-label">Clothes</div>
    </div>
    <div class="cat-item" onclick="navigate('shoes.html')">
      <div class="cat-ico">👟</div><div class="cat-label">Shoes</div>
    </div>
    <div class="cat-item" onclick="navigate('mobiles.html')">
      <div class="cat-ico">📱</div><div class="cat-label">Mobiles</div>
    </div>
    <div class="cat-item" onclick="scrollToSection('deals')">
      <div class="cat-ico">🏷️</div><div class="cat-label">Deals</div>
    </div>
    <div class="cat-item">
      <div class="cat-ico">🎁</div><div class="cat-label">Rewards</div>
    </div>
  </div>
  ...
  <main>
    <section class="section" id="clothes">
      <div class="section-head"><h3>Keep shopping — Clothes</h3><button onclick="navigate('clothes.html')">See all</button></div>
  ...
  <div class="modal" id="buyerModal" aria-hidden="true">
    <div class="modal-card">
      ...
      <div style="margin-top:10px;padding:8px;background:#e6f7ff;border:1px solid #b3e0ff;border-radius:6px;font-size:13px;color:#004085;">
        ✅ **Cash on Delivery (COD) is available!** </div>
  ...
  <div class="modal" id="sellerModal" aria-hidden="true">
    <div class="modal-card admin">
      ...
      <div id="adminArea" style="display:none;margin-top:12px">
        ...
        <div class="row">
          <input id="pPrice" type="number" placeholder="Sale4u Price ₹">
        ...
        <div class="row">
            <input id="pAmazonPrice" type="number" placeholder="Amazon Price ₹">
            <input id="pFlipkartPrice" type="number" placeholder="Flipkart Price ₹">
        </div>
...
function renderHoriz(catId, catName){
  ...
  list.forEach(p=>{
    ...
    div.innerHTML = `<img src="${p.image}" alt=""><div class="p-title">${escapeHtml(p.title)}</div>
      <div class="p-prices">
        <div class="p-price-label">Sale4u Price: <span class="p-price-val p-sale4u">₹${p.price}</span></div>
        <div class="p-price-label">Amazon Price: <span class="p-price-val p-amazon">₹${p.amazonPrice || 'N/A'}</span></div>
        <div class="p-price-label">Flipkart Price: <span class="p-price-val p-flipkart">₹${p.flipkartPrice || 'N/A'}</span></div>
      </div>
      <div class="p-actions">
